...
export default function DashboardPage() {
  ...
  return (
    <MainLayout title={t('dashboard.title')} onStartTour={startOnboarding}>
        ...
        >
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2">Bem-vindo de volta! 👋</h1>
                <p className="text-orange-100 text-sm sm:text-base lg:text-lg">
                  Suas operações do restaurante hoje.
                </p>
              </div>
              {isFirstVisit && (
                <Button
