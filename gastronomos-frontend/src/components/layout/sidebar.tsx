...
export function Sidebar({ collapsed = false, className }: SidebarProps) {
  ...
  const navigation = [
    ...
    },
    {
      ...
      children: [
        { name: t('navigation.products'), href: '/estoque/produtos', icon: GastronomyIcons.Apple },
        { name: t('navigation.categories'), href: '/estoque/categorias', icon: GastronomyIcons.Plate },
        { name: t('navigation.stockLevels'), href: '/estoque/niveis', icon: GastronomyIcons.Warehouse },
      ],
    },
    {
      ...
      children: [
        { name: t('navigation.purchaseOrders'), href: '/compras/pedidos', icon: FileText },
        { name: t('navigation.suppliers'), href: '/compras/fornecedores', icon: Building2 },
        { name: t('navigation.receipts'), href: '/compras/recibos', icon: GastronomyIcons.Receipt },
      ],
    },
    {
      ...
      children: [
        { name: t('navigation.activeTransfers'), href: '/transferencias/ativas', icon: GastronomyIcons.Truck },
        { name: t('navigation.transferHistory'), href: '/transferencias/historico', icon: FileText },
        { name: t('navigation.emergencyTransfers'), href: '/transferencias/emergencia', icon: GastronomyIcons.Timer },
      ],
    },
    {
      ...
      children: [
        { name: t('navigation.currentAllocations'), href: '/alocacoes/atuais', icon: GastronomyIcons.ChartPie },
        { name: t('navigation.templates'), href: '/alocacoes/modelos', icon: FileText },
        { name: t('navigation.unallocatedItems'), href: '/alocacoes/nao-alocados', icon: Package },
      ],
    },
    {
      ...
      children: [
        { name: t('navigation.performance'), href: '/analises/desempenho', icon: GastronomyIcons.TrendingUp },
        { name: t('navigation.costAnalysis'), href: '/analises/custos', icon: GastronomyIcons.ChartPie },
        { name: t('navigation.varianceReports'), href: '/analises/variacao', icon: BarChart3 },
      ],
    },
    {
